...
ItemEvents.tooltip(event => {
  ...
  event.add('pipez:ultimate_upgrade', [
    ...
    event.add(['forbidden_arcanus:stellarite_piece'], '§4ITEM BANIDO')
    event.add(['forbidden_arcanus:stellarite_block'], '§4ITEM BANIDO')
    event.add([Item.of('ae2:facade', '{item:"forbidden_arcanus:stellarite_block"}')], '§4ITEM BANIDO')
    event.add(['ae2:network_tool'], '§4ITEM BANIDO')
    event.add(['mekanism:cardboard_box'], '§4ITEM BANIDO')
    event.add(['forbidden_arcanus:quantum_catcher'], '§4ITEM BANIDO')
    event.add(['ae2:spatial_anchor'], '§4ITEM BANIDO')
    event.add(['mekanism:upgrade_anchor'], '§4ITEM BANIDO')
    event.add(['minecraft:respawn_anchor'], '§4ITEM BANIDO')
    event.add(['createendertransmission:chunk_loader'], '§4ITEM BANIDO')
    event.add(['occultism:storage_controller'], '§4ITEM BANIDO')
    event.add(['occultism:stable_wormhole'], '§4ITEM BANIDO')
    event.add(['occultism:storage_controller_base'], '§4ITEM BANIDO')
    event.add(['occultism:storage_stabilizer_tier1'], '§4ITEM BANIDO')
    event.add(['occultism:storage_stabilizer_tier2'], '§4ITEM BANIDO')
    event.add(['occultism:storage_stabilizer_tier3'], '§4ITEM BANIDO')
    event.add(['occultism:storage_stabilizer_tier4'], '§4ITEM BANIDO')
    event.add(['ae2:formation_plane'], '§4ITEM BANIDO')
    event.add(['ae2:annihilation_plane'], '§4ITEM BANIDO')
    event.add(['draconicevolution:celestial_manipulator'], '§4ITEM BANIDO')
    event.add(['draconicevolution:potentiometer'], '§4ITEM BANIDO')
    event.add(['draconicevolution:rain_sensor'], '§4ITEM BANIDO')
    event.add(['sophisticatedstorage:magnet_upgrade'], '§4ITEM BANIDO')
    event.add(['sophisticatedstorage:advanced_magnet_upgrade'], '§4ITEM BANIDO')
    event.add(['sophisticatedbackpacks:advanced_magnet_upgrade'], '§4ITEM BANIDO')
    event.add(['sophisticatedbackpacks:magnet_upgrade'], '§4ITEM BANIDO')
    event.add(['mekanism:module_magnetic_attraction_unit'], '§4ITEM BANIDO')
    event.add(['ae2wtlib:magnet_card'], '§4ITEM BANIDO')
    event.add(['enderio:electromagnet'], '§4ITEM BANIDO')
    event.add(['advanced_ae:magnet_card'], '§4ITEM BANIDO')
    event.add(['draconicevolution:mob_soul'], '§4ITEM BANIDO')
    event.add(['draconicevolution:stabilized_spawner'], '§4ITEM BANIDO')
