...
StartupEvents.registry('item', event => {
	event.create('mage_leaf').texture("kubejs:item/mage_leaf").displayName('Magically Blooming Leaves')
})

StartupEvents.registry('item', event => {
	event.create('dirty_bowl').texture("kubejs:item/dirty_bowl").displayName('Bowl of Leaves')
})

StartupEvents.registry('item', event => {
	event.create('magebloom_sourceberry_smoothie_bowl').texture("kubejs:item/magebloom_sourceberry_smoothie_bowl").displayName('Magebloom Sourceberry Smoothie Bowl')
})
StartupEvents.registry('item', event => {
	event.create('sourcegem_fragments').texture("kubejs:item/sourcegem_fragments").displayName('Source Crystal Fragments')
})
